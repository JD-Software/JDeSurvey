...
/*Regular Expressions */
SET IDENTITY_INSERT regular_expression ON;
...
SET IDENTITY_INSERT regular_expression OFF;

/*Security Authorities*/
SET IDENTITY_INSERT sec_authority ON;
INSERT INTO sec_authority (id,authority_type, name, description,version) VALUES (1,'I', 'ROLE_ADMIN', 'Highest level access without any restrictions', 0);
...
VALUES (1,'ForgotLogin','<html><body><p><strong>Per your request below is your JD eSurvey Login</strong></p><p>Login: ${user_login}</p></body></html>',0,'2012-10-21 14:44:53');

INSERT INTO velocity_template (id,template_name,template_definition,version,template_timestamp)
VALUES (2,'ForgotPassword','<html><body><p>A password change request for your JD eSurvey account has been made. If you have made this request please use the link below to change your password. If not please ignore this email.</p><p>${reset_password_link}</p></body></html>',0,'2012-10-21 14:44:53');
...
INSERT INTO velocity_template (id,template_name,template_definition,version,template_timestamp)
VALUES (4,'InternalHomePageContent','<p>Welcome ${user_name} to the JD Survey System. The system provides a portal for collecting survey data. Please click on the ''Surveys'' tab in the top menu to get started.</p>',0,'2012-10-21 14:44:53');

INSERT INTO velocity_template (id,template_name,template_definition,version,template_timestamp)
VALUES (5,'ExternalHomePageContent','Your survey has been submitted. Thank you for participating.',0,'2012-10-21 14:44:53');
...
SET IDENTITY_INSERT global_settings ON;
...
SET IDENTITY_INSERT global_settings OFF;
